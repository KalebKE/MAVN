 ...
 * @author Kaleb
 */
public class MatrixTemplatePanelW0 extends MatrixTemplatePanel
{
    /**
     *
     * @param m
     ...
     * @param controlFrame
     */
    public MatrixTemplatePanelW0(int m, int n, ControlFrame controlFrame)
    {
    ...
    public void updateMatrix()
    {
        ...
        controlFrame.setCurrentMatrixW0(matrix);
        controlFrame.updateW0Matrix(matrix);
    }
