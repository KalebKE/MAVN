 ...
 * parsers to be hooked into the application. Functionality for parsing different
 * file types can be added by implementing
 * setModel(String path) with different file parsing Models.
 * An observer pattern is used so new observers can easily
 * register for Model updates. 
 * @author Kaleb
 */
public interface OpenFileModelInterface
{
