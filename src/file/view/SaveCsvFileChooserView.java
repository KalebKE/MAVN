 ...
 * @author Kaleb
 */
public class SaveCsvFileChooserView extends JFileChooser
{
     ...
     */
    public SaveCsvFileChooserView(final FileControllerInterface fileController, final double[][] matrix)
    {
            ...
            {
                {
                    ...
                    SaveCsvFileChooserView.this.fileController.saveCsvFileModel(SaveCsvFileChooserView.this.getSelectedFile().getPath(), matrix);
                }
            }
        });
    }
