 ...
 * @author Kaleb
 */
public class SaveFileChooserView extends JFileChooser
{
     ...
     */
    public SaveFileChooserView(final FileControllerInterface fileController, final double[][] matrix)
    {
            ...
            {
                {
                    ...
                    SaveFileChooserView.this.fileController.setModel(SaveFileChooserView.this.getSelectedFile().getPath(), matrix);
                }
            }
        });
    }
     ...
     * @param fileController
     */
    public SaveFileChooserView(final FileControllerInterface fileController, final String results)
    {
        // Start in the C:/ drive
        super("C:/");
        ...
        this.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                {
                    // Update the controller
                    SaveFileChooserView.this.fileController.setModel(SaveFileChooserView.this.getSelectedFile().getPath(), results);
                }
            }
        });
    }
