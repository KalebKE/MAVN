 ...
 * @author Kaleb
 */
public class SaveTxtFileChooserView extends JFileChooser
{
     ...
     */
    public SaveTxtFileChooserView(final FileControllerInterface fileController, final String results)
    {
            ...
            {
                {
                    ...
                    SaveTxtFileChooserView.this.fileController.saveTxtFileModel(SaveTxtFileChooserView.this.getSelectedFile().getPath(), results);
                }
            }
        });
    }
