...
import mavn.algorithm.model.multiplePointSimulation.state.PixelGridNetworkOutputModelState;
...
import mavn.algorithm.model.multiplePointSimulation.worker.PixelGridSimulationWorker;
 ...
 * @author Kaleb
 */
public class PixelGridSimulation implements AlgorithmModelInterface,
        ...
        ImageRatioAlgorithmModelInterface, TimerAlgorithmModelInterface, ThetaInputModelObserver,
        W0InputModelObserver, W1InputModelObserver, W2InputModelObserver
{
    ...
    public PixelGridSimulation()
    {
        ...
        outputModelResultState = new PixelGridPointOutputModelState(this);
        outputLayerModelState = new PixelGridNetworkOutputModelState(this);
    }
    ...
    public void execute()
    {
        if (inputModelState.isInputModelReady())
        {
            ...
            simulation = new PixelGridSimulationWorker(
                    inputModelState,
