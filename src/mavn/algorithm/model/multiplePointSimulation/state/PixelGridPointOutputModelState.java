 ...
 * PixelGridOutputModelState is the State Manager for the Points
 ...
 * @author Kaleb
 */
public class PixelGridPointOutputModelState implements AlgorithmModelStateInterface
{
    ...
    private PixelGridSimulation model;
     ...
     */
    public PixelGridPointOutputModelState(PixelGridSimulation model)
    {
        this.model = model;
