 ...
 * @author Kaleb
 */
public abstract class MavnControllerAbstract implements MavnControllerInterface
{
     ...
     */
    public void setView(MavnView view)
    {
        this.view = view;
    }
}
