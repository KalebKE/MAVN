...
public interface OutputControllerInterface
{
    ...
    /**
     * Check to see if simulation results are available.
    ...
    /**
     * Indicate if there are simulation results available.
     * @param resultsSet boolean indicating available resuts.
     */
