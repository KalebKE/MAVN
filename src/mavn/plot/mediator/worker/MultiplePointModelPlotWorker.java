 ...
 * Mediator when a non-Animated simulation has produced an Point Hit Output
 * Model and Point Miss Output Model that can be rendered. This SwingWorker
 * keeps the UI from hanging while the Scatter Plot is being rendered.
 *
 * @author Kaleb
 */
public class MultiplePointModelPlotWorker extends SwingWorker
{
     ...
     *
     * Note: This instance is intended to be used only once! A new instance will
     ...
     * @param mediator the Plot Mediator this class will render the Scatter Plot
     * for.
     */
    ...
    protected Object doInBackground() throws Exception
    {
        try
        {
            ...
            while (hits.hasNext())
            {
                ...
                mediator.updatePointHit(pointHit);
            }
            ...
            while (misses.hasNext())
            {
                ...
                mediator.updatePointMiss(pointMiss);
            }
        } catch (Exception e)
        {
            e.printStackTrace();
