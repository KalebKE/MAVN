...
/**
 * Point Miss Output Model Observers are classes that want to Observer the
 * Algorithm Model Subject and be updated when a Point misses a shape in the image
 ...
 * simulation has finished running. Point Miss Ouput Model Observers only
 * update one Miss Point at a time while the simulation is running.
 * @author Kaleb
 */
public interface PointMissOutputModelObserver
{

    /**
     * Update the Point that missed a shape within the image.
