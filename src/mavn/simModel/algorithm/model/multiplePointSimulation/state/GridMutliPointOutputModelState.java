 ...
 * @author Kaleb
 */
public class GridMutliPointOutputModelState implements AlgorithmModelStateInterface
{
    ...
    private GridMultiPointSimulation model;
     ...
     */
    public GridMutliPointOutputModelState(GridMultiPointSimulation model)
    {
        this.model = model;
