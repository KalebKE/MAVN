 ...
 */
package mavn.simModel.algorithm.model.singlePointSimulation;
...
import mavn.simModel.algorithm.model.state.input.InputModelState;
import mavn.simModel.algorithm.model.singlePointSimulation.state.SinglePointLayerOutputModelState;
...
import mavn.simModel.algorithm.model.singlePointSimulation.worker.SinglePointModelWorker;
 ...
 * @author Kaleb
 */
public class SinglePointSimulation implements AlgorithmModelInterface,
        ...
        W2ModelObserver
{
    ...
    public void execute()
    {
        ...
        {
            simulation = new SinglePointModelWorker(inputModelState, outputModelState);
            simulation.execute();
        }
    }
