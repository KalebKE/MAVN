 ...
 * @author Kaleb
 */
public class InputViewW0Model extends InputViewAbstract implements W0ModelObserver
{
     ...
     */
    public InputViewW0Model(InputControllerInterface inputController, InputModelInterface inputModel, InputModelChangeEvent modelChanged)
    {
