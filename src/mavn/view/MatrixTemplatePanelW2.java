 ...
 * @author Kaleb
 */
public class MatrixTemplatePanelW2 extends MatrixTemplatePanel
{
    /**
     * 
     * @param m
     ...
     * @param controlFrame
     */
    public MatrixTemplatePanelW2(int m, int n, ControlFrame controlFrame)
    {
    ...
    public void updateMatrix()
    {
        ...
        controlFrame.setCurrentMatrixW2(matrix);
        controlFrame.updateW2Matrix(matrix);
    }
